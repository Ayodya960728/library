...
public class BorrowingsDto {
    ...
    public BorrowingsDto(Integer book_id, Integer member_id, String borrow_date, String due_date, String return_date, String fine, ArrayList<MemberDto> memberDtos) {
    ...
    /**
     * @param memberDtos the memberDtos to set
     */
    ...
    public String toString() {
        return "BorrowingsDto{" + "book_id=" + book_id + ", member_id=" + member_id + ", borrow_date=" + borrow_date + ", due_date=" + due_date + ", return_date=" + return_date + ", fine=" + fine + ", memberDtos=" + memberDtos + '}';
    }
